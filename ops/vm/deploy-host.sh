...
KIOSK_API_ALLOW_IPS="${KIOSK_API_ALLOW_IPS:-172.20.0.4 172.20.10.0/24 172.16.0.111 172.19.0.9}"
...
Environment overrides:
  ...
  KIOSK_API_ALLOW_IPS="172.20.0.4 172.20.10.0/24 172.16.0.111 172.19.0.9"
  INSTALL_NODE20=1
